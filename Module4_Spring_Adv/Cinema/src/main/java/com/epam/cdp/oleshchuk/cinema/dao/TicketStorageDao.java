...
public class TicketStorageDao implements TicketDao {
    ...
    public synchronized void bookTicketById(Ticket ticket, User user) throws DaoException {
    ...
    private void generateAndPutTickets(int count, String title, Date date, TicketCategory category) {
        ...
        for (int i = 1; i < count + 1; i++) {
            ticket = new Ticket(title, date, category, i);
            ticket = new Ticket(getNextId(), ticket);
