...
public class TicketServiceImpl implements TicketService {
    ...
    public List<Ticket> getAvailableTicket() {
        return ticketDao.getAvailableTicket();
    }
    ...
    public void bookTicket(Ticket ticket, User user) throws ServiceException {
        try {
            ticketDao.bookTicketById(ticket, user);
        } catch (DaoException e) {
            throw new ServiceException(e.getMessage());
        }
    }
    ...
    public List<Ticket> getBookedTickets(List<Long> ticketIds) throws ServiceException {
        try {
            return ticketDao.getBookedTickets(ticketIds);
        } catch (DaoException e) {
            throw new ServiceException(e.getMessage());
        }
    }
